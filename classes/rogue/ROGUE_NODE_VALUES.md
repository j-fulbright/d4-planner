# Rogue Starting Board - Node Value Analysis
...
|-----------|---------|------------------------|-------------|
| **Outlaw** | +30% Damage to Elites, +10 Dexterity | ~62 | 62 |
...
| **Outlaw** (far) | ~17 nodes + rare | 18 | ~80 | 4.44x |
...
**For damage builds:**
1. Outlaw (62 value) - Best single node
...
5. Outlaw (62 value) - Elite damage
...
**All data from:** `classes/rogue/rogue-boards-summary.json`
