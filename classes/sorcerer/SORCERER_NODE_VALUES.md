# Sorcerer Starting Board - Node Value Analysis
...
|-----------|---------|------------------------|-------------|
| **Studied** | +30% Damage to Elites, +10 Intelligence | ~62 | 62 |
| **Elemental Balance** | +20% Non-Physical Damage, +10 Intelligence | ~42 | 42 |
| **Elementalist** | +20% Non-Physical Damage, +4% Maximum Life | ~40 | 40 |
...
|-----------|-------------------|-------------|------------|
| **Studied** (rare) | 1 | 62 | 62.00x |
| **Elemental Balance** (rare) | 1 | 42 | 42.00x |
| **Elementalist** (rare) | 1 | 40 | 40.00x |
...
| **Elementalist** (accessible) | ~7 nodes + rare | 8 | ~48 | 6.00x |
| **Resilience** (accessible) | ~7 nodes + rare | 8 | ~22 | 2.75x |
| **Elemental Balance** (far) | ~15 nodes + rare | 16 | ~58 | 3.63x |
| **Studied** (far) | ~17 nodes + rare | 18 | ~80 | 4.44x |
...
**For damage builds:**
1. Studied (62 value) - Best single node
2. Elemental Balance (42 value) - High damage
3. Magic +10% Damage nodes (20 value) - If on path
4. Elementalist (40 value) - Balanced damage
5. Resilience (14 value) - Defensive

**For tank builds:**
1. Resilience (14 value) - Best defensive rare
2. Elementalist (40 value) - Damage + life
3. Magic +2% Life nodes (4 value) - If on path
4. Elemental Balance (42 value) - Still want damage
5. Studied (62 value) - Elite damage
...
**All data from:** `classes/sorcerer/sorcerer-boards-summary.json`
