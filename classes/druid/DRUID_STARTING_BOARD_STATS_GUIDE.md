# Diablo 4 Druid Starting Board - Complete Stats Guide
...
## 🎯 Starting Board Overview (Board ID: 940011)
...
### 1. Impel
- **Bonuses:** +20% Damage, +10 Willpower
- **Priority:** ⭐⭐⭐ HIGH - All builds benefit

### 2. Reclaim
- **Bonuses:** +30% Damage to Elites, +10 Willpower
- **Priority:** ⭐⭐⭐ HIGH - Boss encounters

### 3. Tenacity
- **Bonuses:** 4% Maximum Life, +2% Total Armor
- **Priority:** ⭐⭐⭐ HIGH - Werebear synergy

### 4. Prime
- **Bonuses:** +20% Damage, 4% Maximum Life
- **Priority:** ⭐⭐⭐ HIGH - Tank + damage
...
- Prioritize: **Tenacity**, **Prime**
- Legendary Boards: Earthen Devastation, Ursine Strength
- Path: Armor/Life for Overpower scaling

### Tornado Build (Storm)
- Prioritize: **Impel**, **Reclaim**
- Legendary Boards: Cyclonic Force, Tempest Roar
- Path: AoE elite farming

### Landslide Build (Earth)
- Prioritize: **Impel**, **Prime**
- Legendary Boards: Seismic Shift, Might of the Earth
- Path: Critical Strike focus

---

## 💡 Pro Tips

1. **Primary Stat Scaling:** +5 Willpower per common node
...
**Class:** Druid | **Primary Stat:** Willpower | **Resource:** Spirit
