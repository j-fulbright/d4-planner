# Druid Starting Board - Node Value Analysis
...
|-----------|---------|------------------------|-------------|
| **Reclaim** | +30% Damage to Elites, +10 Willpower | ~62 | 62 |
| **Impel** | +20% Damage, +10 Willpower | ~42 | 42 |
...
|-----------|-------------------|-------------|------------|
| **Reclaim** (rare) | 1 | 62 | 62.00x |
| **Impel** (rare) | 1 | 42 | 42.00x |
...
| **Impel** (far) | ~15 nodes + rare | 16 | ~58 | 3.63x |
| **Reclaim** (far) | ~17 nodes + rare | 18 | ~80 | 4.44x |
...
**For damage builds:**
1. Reclaim (62 value) - Best single node
2. Impel (42 value) - High damage
...
4. Impel (42 value) - Still want damage
5. Reclaim (62 value) - Elite damage
...
**All data from:** `classes/druid/druid-boards-summary.json`
