# Spiritborn Starting Board - Node Value Analysis
...
|-----------|---------|------------------------|-------------|
| **Spiritual** | +30% Damage to Elites, +10 Dexterity | ~62 | 62 |
| **Skillful** | +20% Damage, +10 Dexterity | ~42 | 42 |
...
|-----------|-------------------|-------------|------------|
| **Spiritual** (rare) | 1 | 62 | 62.00x |
| **Skillful** (rare) | 1 | 42 | 42.00x |
...
| **Skillful** (far) | ~15 nodes + rare | 16 | ~58 | 3.63x |
| **Spiritual** (far) | ~17 nodes + rare | 18 | ~80 | 4.44x |
...
**For damage builds:**
1. Spiritual (62 value) - Best single node
2. Skillful (42 value) - High damage
...
4. Skillful (42 value) - Still want damage
5. Spiritual (62 value) - Elite damage
...
**All data from:** `classes/spiritborn/spiritborn-boards-summary.json`
