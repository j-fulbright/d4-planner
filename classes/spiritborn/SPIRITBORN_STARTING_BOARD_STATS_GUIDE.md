# Diablo 4 Spiritborn Starting Board - Complete Stats Guide
...
## 🎯 Starting Board Overview (Board ID: 1985956)
...
### 1. Skillful
- **Bonuses:** +20% Damage, +10 Dexterity
- **Priority:** ⭐⭐⭐ HIGH - Universal damage

### 2. Spiritual
- **Bonuses:** +30% Damage to Elites, +10 Dexterity
- **Priority:** ⭐⭐⭐ HIGH - Elite encounters

### 3. Tenacity
- **Bonuses:** 4% Maximum Life, +2% Total Armor
- **Priority:** ⭐⭐⭐ HIGH - Gorilla form synergy

### 4. Prime
- **Bonuses:** +20% Damage, 4% Maximum Life
- **Priority:** ⭐⭐⭐ HIGH - Hybrid scaling
...
### Quill Volley Build (Eagle)
- Prioritize: **Skillful**, **Spiritual**
- Legendary Boards: Feather of the Eagle, Soaring Strikes
- Path: Projectile damage

### Rake Build (Jaguar)
- Prioritize: **Skillful**, **Prime**
- Legendary Boards: Claw of the Jaguar, Feral Rage
- Path: Attack Speed scaling

### Touch of Death Build (Centipede)
- Prioritize: **Spiritual**, **Tenacity**
- Legendary Boards: Sting of the Centipede, Toxic Skin
- Path: Poison DoT stacking

---

## 💡 Pro Tips

1. **Primary Stat Scaling:** +5 Dexterity per common node
2. **Rare Node Value:** 20-40x more valuable than common nodes
3. **Respec is Free:** Experiment without penalty
4. **Center Rush:** Most efficient for unlocking legendary boards
5. **Elite Damage:** The +30% elite damage rare is always worth taking
...
**Class:** Spiritborn | **Primary Stat:** Dexterity | **Resource:** Vigor
